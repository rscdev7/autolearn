# Dependencies Description - session
...
> * `$HOME_COMPONENT/lib/pydantic_models/ClearSessionRequest.py`
> * `$HOME_COMPONENT/lib/pydantic_models/SessionRequest.py`
> * `$HOME_COMPONENT/lib/rest_api/rest_end_point.py`
...
> * `$HOME_COMPONENT/lib/service_utility/utils.py`

-----

#### **Data Dependencies:**
> * `$HOME_COMPONENT/data/secret_key.txt`, chiave segreta per cifrare/decifrare i messaggi confidenziali