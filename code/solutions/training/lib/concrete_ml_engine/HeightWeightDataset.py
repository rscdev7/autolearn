...
Questo componente implementa un modulo che carica in memoria il dataset Height-Weight e contestualmente lo suddivide in training, validation e test-set.
"""
