...
Questo componente permette di avviare il Microservizio training
"""
...
def set_up_rest_end_point () -> Tuple[ APIRouter , ServiceConfig , AutoLearnLogEntity , KafkaEventStore , dict , Logger ]:
    ...
    Questa funzione permette di configurare il Microservizio training lato REST.
    ...
    LOGGER_NAME:str                                     = "training__"+str ( os.getpid() )
    LOG_PATH:str                                        = "./log"
